...
@Transactional
@Component
public class RequeteSection {
	@Autowired
	SessionFactory sessionFactory;
	
	
	public List<Section> recupSectionByFiliere(int codeFiliere){
	String query = "SELECT `section`.* FROM `section` WHERE (`section`.`CODE_FILIERE` ='"+codeFiliere+"')";	
